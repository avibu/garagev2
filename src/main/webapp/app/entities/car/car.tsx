...
import { getSearchEntities, getEntities } from './car.reducer';
...
export interface ICarState extends IPaginationBaseState {
  search: string;
}
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('licensePlate')}>
                  License Plate <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('make')}>
                  Make <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {carList.map((car, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{car.model}</td>
                  <td>{car.year}</td>
                  <td>{car.clientId ? <Link to={`client/${car.clientId}`}>{car.clientId}</Link> : ''}</td>
